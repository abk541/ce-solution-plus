      ...
      <div className="shell py-16 md:py-20">
        ...
        <div className="mt-14 grid gap-12 border-t border-ink-800 pt-12 md:grid-cols-12">
          <div data-footer-item className="md:col-span-4">
            <Logo tone="light" variant="compact" className="h-9 w-[188px]" />
            ...
            <ul className="mt-5 space-y-3">
              {navLinks.map((link) => (
                <li key={link.href}>
                  <a
                    href={link.href}
                    className="group inline-flex items-center gap-2 text-sm text-steel-200 transition-colors duration-[var(--motion-micro)] hover:text-accent"
                  >
                    <span
                      aria-hidden="true"
                      className="h-px w-0 bg-accent transition-all duration-[var(--motion-ui)] ease-[var(--ease-spring)] group-hover:w-4"
                    />
                    {link.label}
                  </a>
                </li>
          ...
          <div data-footer-item className="md:col-span-3">
            ...
            <address className="mt-5 not-italic text-sm leading-relaxed text-steel-200">
              ...
              <a
                ...
                className="mt-3 inline-flex min-h-6 items-center py-1 transition-colors duration-[var(--motion-micro)] hover:text-accent"
              >
                {company.email}
              </a>
              <br />
              <a
                ...
                className="inline-flex min-h-6 items-center py-1 transition-colors duration-[var(--motion-micro)] hover:text-accent"
              >
                {company.phone}
              </a>
            </address>
              ...
              {company.social.map((link) => (
                <li key={link.label}>
                  <a
                    ...
                    className="inline-flex min-h-6 items-center py-1 text-sm text-steel-200 transition-colors duration-[var(--motion-micro)] hover:text-accent"
                  >
                    {link.label}
                  </a>
                </li>
        ...
        <div
          data-footer-item
          className="mt-14 flex flex-col gap-4 border-t border-ink-800 pt-8 sm:flex-row sm:items-center sm:justify-between"
        >
          ...
          <a
            href="#top"
            className="group inline-flex items-center gap-3 label-mono text-[0.55rem] text-steel-400 transition-colors duration-[var(--motion-micro)] hover:text-accent"
          >
            Back to top
            <svg viewBox="0 0 10 14" aria-hidden="true" className="h-3 w-2.5 transition-transform duration-[var(--motion-ui)] ease-[var(--ease-spring)] group-hover:-translate-y-1" fill="none">
